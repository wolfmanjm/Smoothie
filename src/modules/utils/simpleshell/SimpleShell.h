...
private:
    ...
    static void step_command( string parameters, StreamOutput *stream);
    static void step(uint8_t axis, uint32_t steps, bool dir, uint32_t delayusec, StreamOutput *stream);
